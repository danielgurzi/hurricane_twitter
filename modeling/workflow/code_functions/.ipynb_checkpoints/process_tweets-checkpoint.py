...
if __name__ == '__main__':
    disaster_specific = ['mendocinocomplex', 'ca', 'wildfire', 'mendocinocomplex', 'wildfires', 'ventura', 'montecito', 'cal',
                         'cal_fire']

    dataframe = process_data_by_tweet('../data/mendocinocomplex/twitter_retrieval/mendocinocomplex_pre.csv', disaster_specific)
